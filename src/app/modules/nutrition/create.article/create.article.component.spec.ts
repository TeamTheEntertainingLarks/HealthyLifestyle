...
describe('CreateArticleComponent', () => {
  ...
  it('title field required', () => {
    let errors = {};
    let title = component.articleForm.controls['titleFormControl'];
    errors = title.errors || {};
  ...
  it('description field required', () => {
    let errors = {};
    let description = component.articleForm.controls['descriptionFormControl'];
  ...
  it('description field should not throw if valid value is passed', () => {
    ...
    let description = component.articleForm.controls['descriptionFormControl'];
    errors = description.errors || {};
    description.setValue('Description, description, description, description, description, description description, description, description');
    expect(errors['required']).toBeTruthy();
    expect(errors['pattern']).toBeFalsy();
  });
  ...
  it('submitting a form emits an article', () => {
    ...
    component.articleForm.controls['descriptionFormControl'].setValue('Description, description, description, description, description, description description, description, description');
